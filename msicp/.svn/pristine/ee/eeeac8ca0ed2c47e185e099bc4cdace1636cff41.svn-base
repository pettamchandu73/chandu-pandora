/* 
 * $Id: ucontact.h,v 1.2 2006/12/15 08:10:16 hari Exp $ 
 *
...
/*
 * Update existing contact in memory with new values (based on contact)
 */
 ...
 * original function which takes callid as input
 *
 * Update existing contact in memory with new values (based on callid)
 */
...
/*
 * Update ucontact with new values without replication (based on contact)
 */
 ...
 * ----- function introduced by svrk
 *  this function takes contact as input unlike the 
 *  original function which takes callid as the input
 *  
 *  * Update ucontact with new values without replication (based on callid)
 */
typedef int (*update_ucontact_bycallid_t)(ucontact_t* _c, time_t _e, qvalue_t _q, str* contact, int _cs, 
