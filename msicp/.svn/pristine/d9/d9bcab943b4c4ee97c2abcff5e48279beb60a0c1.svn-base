/* 
 * $Id: urecord.h,v 1.2 2006/12/15 08:10:16 hari Exp $ 
 *
 ...
 *  original function which takes the contact
 *  
 *  * Get pointer to ucontact with given callid
 *   */
typedef int (*get_ucontact_bycallid_t)(urecord_t* _r, str* callid, struct ucontact** _co);
