#!/usr/bin/php4 -q
<?php
// $Id: fifo_server.php,v 1.1.1.1 2006/08/31 22:40:54 hari Exp $
 ...
 *             until msicp fifo natively supports tcp/ip access
 */

error_reporting (E_ALL);

require("/etc/msicp/fifo_server.cfg");
...
$fifo_clients = "/etc/msicp/fifo_server.clients";
...
do {
  ...
  $fifo_handle=fopen( "/tmp/msicp_fifo", "w" );
  if (!$fifo_handle) {
