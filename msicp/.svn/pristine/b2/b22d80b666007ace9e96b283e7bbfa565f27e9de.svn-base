#!/bin/sh
#
# $Id: ser_mysql.sh,v 1.1.1.1 2006/08/31 22:40:53 hari Exp $
#
# Script for adding and dropping msicp MySql tables
#
...
EOF
	...
	if [ "$?" -ne 0 ]; then
		echo "msicp backup/restore failed"
		rm $BU
		exit 1
	fi
}
...
# Users: msicp is the regular user, serro only for reading
