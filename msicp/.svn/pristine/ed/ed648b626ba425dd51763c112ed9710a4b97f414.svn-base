...
# $Header: /usr/local/cvsroot/msicp-1.3/fifocore/gentoo/msicp-0.8.12.ebuild,v 1.1.1.1 2006/08/31 22:40:54 hari Exp $

DESCRIPTION="SIP Express Router"

HOMEPAGE="http://www.iptel.org/msicp"
SRC_URI="ftp://ftp.berlios.de/pub/msicp/0.8.12/src/${P}_src.tar.gz"
