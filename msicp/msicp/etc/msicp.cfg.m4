...
#
# $Id: msicp.cfg.m4,v 1.1.1.1 2006/08/31 22:40:53 hari Exp $
#
# msicp.cfg m4 template
#
...
loadmodule "/usr/local/lib/msicp/modules/tm.so"
loadmodule "/usr/local/lib/msicp/modules/sl.so"
loadmodule "/usr/local/lib/msicp/modules/acc.so"
loadmodule "/usr/local/lib/msicp/modules/rr.so"
loadmodule "/usr/local/lib/msicp/modules/maxfwd.so"
loadmodule "/usr/local/lib/msicp/modules/mysql.so"
loadmodule "/usr/local/lib/msicp/modules/usrloc.so"
loadmodule "/usr/local/lib/msicp/modules/registrar.so"
loadmodule "/usr/local/lib/msicp/modules/auth.so"
loadmodule "/usr/local/lib/msicp/modules/auth_db.so"
loadmodule "/usr/local/lib/msicp/modules/textops.so"
loadmodule "/usr/local/lib/msicp/modules/uri.so"
loadmodule "/usr/local/lib/msicp/modules/group.so"
loadmodule "/usr/local/lib/msicp/modules/msilo.so"
loadmodule "/usr/local/lib/msicp/modules/nathelper.so"
loadmodule "/usr/local/lib/msicp/modules/enum.so"
loadmodule "/usr/local/lib/msicp/modules/domain.so"
#loadmodule "/usr/local/lib/msicp/modules/permissions.so"

modparam("usrloc|acc|auth_db|group|msilo", "db_url", "sql://msicp:heslo@localhost/msicp")
