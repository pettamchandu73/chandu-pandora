...
1.4.18. External Usage of TM
 ...
 \n
   ...
   (Filename is to where a report will be dumped. msicp assumes
...
[jiri@bat jiri]$ cat > /tmp/msicp_fifo
:t_uac_from:xxx
MESSAGE
...
.
   ...
   or cat test/transaction.fifo > /tmp/msicp_fifo
     _________________________________________________________
...
Chapter 3. Frequently Asked Questions
   ...
   Take a look at http://iptel.org/msicp.
