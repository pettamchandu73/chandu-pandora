/*
 * $Id: usrloc.c,v 1.2 2006/12/15 08:10:16 hari Exp $
 *
 * Usrloc interface
 *
...
int bind_usrloc(usrloc_api_t* api)
{
	...
	api->get_ucontact_bycallid = (get_ucontact_t)find_export("ul_get_ucontact_bycallid", 1, 0);
	if (api->get_ucontact_bycallid == 0) {
		LOG(L_ERR, "bind_usrloc(): Can't bind get_ucontact_bycallid\n");
		return -1;
	}
	
	api->update_ucontact_bycallid = (update_ucontact_bycallid_t)find_export("ul_update_ucontact_bycallid", 1, 0);
	if (api->update_ucontact_bycallid == 0) {
		LOG(L_ERR, "bind_usrloc(): Can't bind update_ucontact_bycallid\n");
		return -1;
	}
